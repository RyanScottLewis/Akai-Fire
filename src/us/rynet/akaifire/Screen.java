...
public class Screen {
  ...
  public static final byte[][] BIT_MUTATE = { { 13, 19, 25, 31, 37, 43, 49 }, { 0, 20, 26, 32, 38, 44, 50 }, { 1, 7, 27, 33, 39, 45, 51 }, { 2, 8, 14, 34, 40, 46, 52 }, { 3, 9, 15, 21, 41, 47, 53 }, { 4, 10, 16, 22, 28, 48, 54 }, { 5, 11, 17, 23, 29, 35, 55 }, { 6, 12, 18, 24, 30, 36, 42 } };

  protected byte[] bitmap = new byte[1171]; // The OLED has 1171 bytes for xfer: ceil(128*64/7)
